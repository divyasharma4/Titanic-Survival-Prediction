setwd("C:/Users/Divya Sharma/Desktop/myprojects/titanic")
library(readr)
train <- read_csv("C:/Users/Divya Sharma/Desktop/myprojects/titanic/train.csv")
View(train)
test <- read_csv("C:/Users/Divya Sharma/Desktop/myprojects/titanic/test.csv")
View(test)
str(train)
...
#No difference for child so continue with Sex
train$Fare2 <- '30+'
...
set.seed(415)
#avoid different classification
